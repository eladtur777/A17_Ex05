...
namespace Ex02_Othelo
{
    public class UserInterface
    {
        ...
        public void ManipulateUserChoiceForFirstPlayer()
        {
        ...
        private void CheckLegalBoardSizeFromPlayer(string i_GetPlayerBoardSize)
        {
            ...
            if (((m_GetUserBoardSize == (int)eBoardSize.Eight - 2 || m_GetUserBoardSize == (int)eBoardSize.Ten - 2) && parseUserInput) == false)
            {
                do
                {
                ...
                while (((m_GetUserBoardSize == (int)eBoardSize.Eight - 2 || m_GetUserBoardSize == (int)eBoardSize.Ten - 2) && parseUserInput) == false);
            }
        }
        ...
        private void UpdateBoard(char[] i_charArray, Player i_player)
        {
            ...
            isLegalMove = m_Game.LegalMove(i_player, pointToSend, eOnlyCheck.No);
            if (!isLegalMove)
            {
